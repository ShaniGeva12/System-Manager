...
function BodyLayout() {
    ...
    return (
        <>
            ...
            >
                <div className={style.item + (themeMode === darkTheme? ' ' + style.dark : '')} key="1"> 1 </div>
                <div className={style.item + (themeMode === darkTheme? ' ' + style.dark : '')} key="2"> 2 </div>
                <div className={style.item + (themeMode === darkTheme? ' ' + style.dark : '')} key="3"> 3 </div>
            </ResponsiveGridLayout>
        </>
    )
}
